        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastKnownAddressId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__BrandCate__Brand__3A81B327",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "BrandId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__BrandCate__Categ__3B75D760",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategorySpecsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    SpecId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__C0F6EFD97E5EFA6E", x => x.CategorySpecsId);
                    table.ForeignKey(
                        name: "FK__CategoryS__Categ__3C69FB99",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__CategoryS__SpecI__3D5E1FD2",
                        column: x => x.SpecId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrdersPr__F92EF86A0C24444F", x => x.OrdersProductsId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Prod_CatSpecId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CategorySpecsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prod_CatSpec", x => x.Prod_CatSpecId);
                    table.ForeignKey(
                        name: "FK__Prod_CatS__Categ__4222D4EF",
                        column: x => x.CategorySpecsId,
                        principalTable: "CategorySpecs",
                        principalColumn: "CategorySpecsId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK__Prod_CatS__Produ__4316F928",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prod_CatSpec_CategorySpecsId",
                table: "Prod_CatSpec",
                column: "CategorySpecsId");

            migrationBuilder.CreateIndex(
                name: "IX_Prod_CatSpec_ProductId",
                table: "Prod_CatSpec",
                column: "ProductId");
